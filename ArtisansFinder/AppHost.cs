...
using ArtisansFinder.Controllers;
using ArtisansFinder.Logic;
using ArtisansFinder.Models;
using ArtisansFinder.ServiceInterface;
...
//        }
    ...
    public class AppHost : AppHostBase 
    {
        public AppHost() //Tell ServiceStack the name and where to find your web services  
            : base("Naija Artisans Finder", typeof(HelloService).Assembly) { }
        ...
        public override void Configure(Funq.Container container)
        {
            ...
            dbFactory.Run(db => db.DropAndCreateTable<Artisan>());
            dbFactory.Run(db => db.DropAndCreateTable<Job>());
            dbFactory.Run(db => db.DropAndCreateTable<Feedback>());
            dbFactory.Run(db => db.DropAndCreateTable<FavoriteArtisan>());
            dbFactory.Run(db => db.DropAndCreateTable<Feedback>());
...
//            Plugins.Add(new SwaggerFeature());
            ...
            container.Register<IMailService>(new MockMailService());
#if DEBUG
            container.Register<IMailService>(new MockMailService());
#else
